...
#Present
pres_folder = "./data/processed_data/env_sel/present/plants/"
...
fut_files <- list.files(paste0("./data/processed_data/env_sel/future/plants/", RCP1), full.names = T, 'tif$|bil$')
#head(fut_files)
...
fut_files2 <- list.files(paste0("./data/processed_data/env_sel/future/plants/", RCP2), full.names = T, 'tif$|bil$')
#head(fut_files2)
...
dir.create(paste0("./data/processed_data/plants/", sp_names[a])) ##Fazer o loop aqui
...
dir.create(paste0("./data/processed_data/plants/", sp_names[a], "/Pres_env_crop/"))
...
writeRaster(present_ly2, filename=paste0("./data/processed_data/plants/", sp_names[a], "/Pres_env_crop/", names(present_ly2)), bylayer=TRUE, format="GTiff")

dir.create(paste0("./data/processed_data/plants/",sp_names[a], "/Fut_env_crop/"))
dir.create(paste0("./data/processed_data/plants/",sp_names[a], "/Fut_env_crop/RCP45/"))
names(future_ly2) <- c("bio_14","bio_15","bio_2","bio_7","bio_8") ##name the rasters as in your model
writeRaster(future_ly2, filename=paste0("./data/processed_data/plants/", sp_names[a], "/Fut_env_crop/rcp45/", names(future_ly2)), bylayer=TRUE, format="GTiff")
dir.create(paste0("./data/processed_data/plants/",sp_names[a], "/Fut_env_crop/RCP85/"))
names(future_ly4) <- c("bio_14","bio_15","bio_2","bio_7","bio_8") ##name the rasters as in your model
writeRaster(future_ly4, filename=paste0("./data/processed_data/plants/", sp_names[a], "/Fut_env_crop/rcp85/", names(future_ly4)), bylayer=TRUE, format="GTiff")
