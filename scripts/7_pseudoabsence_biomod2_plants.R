...
for (a in 1:length(sp_names)){
  ...
  raster_files <- list.files(paste0("./data/processed_data/plants/", sp_names[a], "/Pres_env_crop"), full.names = T, 'tif$|bil$')
  ...
  write.csv(pa.all.xy, paste0("./data/processed_data/plants/",sp_names[a], "/pseudoabs1.csv"), row.names = F) ##no loop colocar dentro da pasta de cada espécie
  write.csv(pa.all.xy2, paste0("./data/processed_data/plants/",sp_names[a], "/pseudoabs2.csv"), row.names = F) ##no loop colocar dentro da pasta de cada espécie
  ...
  write.csv(pres_pseudo_table,paste0("./data/processed_data/plants/", sp_names[a],"/pres_pseudoabs.csv"), row.names = F)
  write.csv(pres_pseudo_table2,paste0("./data/processed_data/plants/", sp_names[a],"/pres_pseudoabs2.csv"), row.names = F)
