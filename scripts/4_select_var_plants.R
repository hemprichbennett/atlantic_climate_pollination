...
present_list <- list.files("./data/processed_data/env_cropped/present", pattern = "tif$", full.names = T)
...
write.csv(all_table, "./results/6_variables_correlation_spearman.csv")
write.csv(all_table2, "./results/6_variables_correlation_pearson.csv")
