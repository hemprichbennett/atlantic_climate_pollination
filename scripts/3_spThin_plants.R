...
# loading clean occs
clean_df <- read_csv("./data/processed_data/plants/02_clean_occ.csv")
...
n_records <- read_csv("./data/processed_data/plants/02_n_records.csv")
...
# writing outputs
write_csv(n_records, path = "./data/processed_data/plants/03_n_thinned_records.csv")
write_csv(clean_df_thin_5, path = "./data/processed_data/plants/03_clean_df_thin_5.csv")
write_csv(clean_df_thin_10, path = "./data/processed_data/plants/03_clean_df_thin_10.csv")
